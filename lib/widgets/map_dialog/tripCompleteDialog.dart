      ...
      children: [
        Dialog(
          child: SizedBox(
            ...
            child: Obx(
               () {
                return cabMapController.isRideCompleteDataLoading.value ? Center(child: CircularProgressIndicator()): Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        CommonText(
                          text:'${cabMapController.rideDetailsResponse?.data?.first.uniqueId}',
                          fontWeight: FontWeight.w600,
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(
                               ...
                               CommonText(text:Utility.dateAndTime(cabMapController.rideDetailsResponse?.data?.first.endTime.toString() ?? "")),
                              SizedBox(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 2),
                                    CommonText(
                                      text: '${cabMapController.rideDetailsResponse?.data?.first.originAddress?.first.address}',
                                      fontSize: 14,
                                      textOverflow:
                                    ...
                                    SizedBox(height: 2),
                                    CommonText(
                                      text: '${cabMapController.rideDetailsResponse?.data?.first.destinationAddress?.first.address}',
                                      fontSize: 14,
                                      textOverflow:
                                      TextOverflow.ellipsis, // Handle overflow
                                    ),
                        ...
                        CommonText(
                          text: '₹ ${cabMapController.rideDetailsResponse?.data?.first.estimatedPrice} to the driver',
                          fontSize: 12,
                          fontWeight: FontWeight.w600,
                        ),
                        ListTile(
                          ...
                          title: Row(
                            children: [
                              CommonText(
                                text: cabMapController.rideDetailsResponse?.data?.first.driverDetails!.first.name.toString() ?? "",
                                fontSize: 15,
                          ...
                          subtitle: Row(
                            children: [
                              ...
                              CommonText(text: cabMapController.rideDetailsResponse?.data?.first.driverDetails?.first.rating.toString() ?? ""),
                              Spacer(),
                              CommonText(
                                text: "Payment Option",
                                fontSize: 12,
