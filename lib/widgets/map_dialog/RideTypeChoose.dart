...
class RideTypeChoose extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.rideDuration.value =
        rideEstimationList.first.estimation!.duration!.toDouble();
    controller.rideDistance.value =
        rideEstimationList.first.estimation!.distance.toString();
                        ...
                        children: [
                                            ...
                                            onChanged: (value) {
                                              ...
                                              controller.price.value =
                                                  rideEstimationList[index]
                                                      ...
                                                      .toDouble();
                                              debugPrint(
                                                  "price of ride ${controller.price.value}");
                          ...
                          ElevatedButton(
                              style: ButtonStyle(
                                ...
                                minimumSize:
                                    WidgetStateProperty.all(Size(340, 70)),
                              ),
                              onPressed: () {
