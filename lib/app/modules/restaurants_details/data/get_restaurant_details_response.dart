...
GetRestaurantDetailsResponse getRestaurantDetailsResponseFromJson(String str) =>
    GetRestaurantDetailsResponse.fromJson(json.decode(str));

String getRestaurantDetailsResponseToJson(GetRestaurantDetailsResponse data) =>
...
/// is_active : 1
/// is_available : 1
/// name : "KrPuram-Lazeez Bhuna Murgh Biryani (Dum Chicken Biryani - Serves 1)"
/// price : "99.99"
...
class StoreProducts {
  ...
  StoreProducts.fromJson(dynamic json) {
    ...
    _images =
        json['images'] != null ? DishImages.fromJson(json['images']) : null;
...
DishImages dishImagesFromJson(String str) =>
    DishImages.fromJson(json.decode(str));
...
class DishImages {
  ...
  DishImages.fromJson(dynamic json) {
