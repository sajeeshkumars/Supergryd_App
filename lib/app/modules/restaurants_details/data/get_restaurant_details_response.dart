...
class GetRestaurantDetailsResponse {
  ...
  String? _message;
  Data? _data;
GetRestaurantDetailsResponse copyWith({  num? status,
  String? message,
  Data? data,
}) => GetRestaurantDetailsResponse(  status: status ?? _status,
...
class StoreProducts {
  ...
  StoreProducts.fromJson(dynamic json) {
    ...
    _images = json['images'] != null ? DishImages.fromJson(json['images']) : null;
