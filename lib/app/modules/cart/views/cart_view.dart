              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(
                      left: 20, bottom: 120, right: 20, top: 10),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: controller.viewCartResponse?.data
                                            ?.cartItmes?.length ??
                                        0,
                                    itemBuilder: (context, index) {
                                      // var _count = controller.viewCartResponse?.data!.cartItmes?[index].quantity ?? 1;
                                      var _count = controller.productQuantities[
                                              controller
                                                  .viewCartResponse
                                                  ?.data!
                                                  .cartItmes?[index]
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (_count >
                                                                            ...
                                                                            controller.removeFromCart(controller.finalCartItems.firstWhere((item) =>
                                                                                item.productId ==
                                                                                controller.viewCartResponse?.data?.cartItmes?[index].productId));
                                                                            controller.addToCart(context: context, storeId: controller.viewCartResponse?.data!.storeId?.toInt() ?? 0).then((value) {
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                            () {
                                                                          controller.addProductToCartFromCart(controller
                                                                              .viewCartResponse!
                                                                              .data!
                                                                              .cartItmes![index]);
                                                                          controller
                                                                              .addToCart(context: context, storeId: controller.viewCartResponse?.data!.storeId?.toInt() ?? 0)
                                                                              .then((_) {
                                                                            if (controller.addToCartResponse?.data?.statusCode ==
                                                                                1) {
                                                                              _count + 1;
                                                                            }
                                                                          });
                                                          ...
                                                          Flexible(
                                                            ...
                                                            child: CommonText(
                                                                text:
                                                                    '₹ ${controller.viewCartResponse?.data!.cartItmes?[index].finalPrice?.toStringAsFixed(2)}'),
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                            ...
                            child: Column(
                              children: [
                                BillItems(
                                  title: 'Item Total',
                                  price:
                                      '₹ ${controller.viewCartResponse?.data?.cartMeta?.cartSubtotalWithoutPacking}',
                                ),
                                BillItems(
                                  title: 'Delivery Fee',
                                  price:
                                      '₹ ${controller.viewCartResponse?.data?.cartMeta?.deliveryCharges}',
                                ),
                                BillItems(
                                  title: 'GST & Restaurant Changes',
                                  price: '₹ ${controller.formattedTotal}',
                                ),
                                BillItems(
                                  title: 'Platform Fee',
                                  price: '₹ 0',
                                ...
                                Row(
                                  children: [
                                    ...
                                    CommonText(
                                      text:
                                          '₹ ${controller.viewCartResponse?.data?.cartMeta?.cartTotal}',
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600,
                                    ),
                                  ],
