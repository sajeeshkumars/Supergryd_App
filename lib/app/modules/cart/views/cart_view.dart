                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: controller.viewCartResponse?.data?.cartItmes?.length,
                                    itemBuilder: (context, index) {
                                      var _count = controller.viewCartResponse?.data!.cartItmes?[index].quantity;
                                      return Padding(
                        ...
                        ListTile(
                          ...
                          leading: CommonText(text: 'Apply Coupon Code',textColor: AppColors.primaryColor,),
                          trailing: Icon(Icons.arrow_forward_ios,size: 15,color: AppColors.primaryColor,),
                        ),
                        SizedBox(height: 10,),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Spacer(),
                                    CommonText(text: '₹ ${controller.viewCartResponse?.data?.cartMeta?.cartTotal}',fontSize: 16,fontWeight: FontWeight.w600),
                                  ],
                                ),
                              ],
                            ),
