    ...
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            flexibleSpace: Obx(
               () {
                return cartController.isTrackOrderLoading.value ? CircularProgressIndicator(): Container(
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return SizedBox(
                        height: 30,
                        child: ListTile(
                          leading: CommonText(text: 'Mango Shake'),
                          trailing: CommonText(text: '₹ 59'),
                        ),
                      );
                    },
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        CommonText(text: ' ₹ 59',fontWeight: FontWeight.w700,)
                      ],
                    ),
                  )
