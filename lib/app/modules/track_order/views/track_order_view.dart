...
class TrackOrderView extends GetView<TrackOrderController> {
  ...
  Widget build(BuildContext context) {
    debugPrint(
        "cart count in track order ${cartController.viewCartResponse?.data?.cartItmes?.length}");
    return PopScope(
      canPop: false,
      child: Scaffold(
          appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                flexibleSpace: Obx(() {
                  return (cartController.isTrackOrderLoading.value &&
                            ...
                            children: [
                              ...
                              ListView.builder(
                                ...
                                itemCount: cartController
                                    .viewCartResponse?.data?.cartItmes?.length,
                                itemBuilder: (context, index) {
                                  return SizedBox(
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: CommonText(
                                          text:
                                              '₹ ${cartController.viewCartResponse?.data!.cartItmes?[index].effectiveItemPrice?.toStringAsFixed(2)}'),
                                    ),
                                  );
                                },
                              ),
                              ...
                              SizedBox(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: CommonText(
                                    text:
                                        '₹ ${cartController.viewCartResponse?.data?.cartMeta?.cartSubtotalWithoutPacking}',
                                  ),
                                ),
                              ),
                              SizedBox(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: CommonText(
                                    text:
                                        '₹ ${cartController.viewCartResponse?.data?.cartMeta?.deliveryCharges}',
                                  ),
                                ),
                              ),
                              SizedBox(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    CommonText(
                                      text:
                                          ' ₹ ${cartController.viewCartResponse?.data?.cartMeta?.cartTotal}',
                                      fontWeight: FontWeight.w700,
                                    )
                                  ],
                                ),
                              ),
                              (cartController.orderTrackResponse?.status ?? 0) <
                                      10
                                  ? Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: CommonButton(
