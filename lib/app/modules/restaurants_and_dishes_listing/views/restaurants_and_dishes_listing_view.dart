                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              CommonText(
                                text:
                                "We're currently out of ${controller
                                    .selectedCategory.value == 0
                                    ? "Veg"
                                    : "Non Veg"} items, but our ${controller
                                    .selectedCategory.value == 1
                                    ? "Veg"
                                    : "Non Veg"} selection is sizzling! Take a look!",
                                fontSize: 16,
                                fontWeight:
                                FontWeight.w600,
                                textAlign:
...
class DishCard extends StatefulWidget {
  final int index;
   ...
   DishCard({super.key,
    ...
    this.restaurantsDetailsController, required  this.count});
...
class _DishCardState extends State<DishCard> {
  ...
  void _incrementCount() {
    setState(() {
      ...
      widget.count++;
      homeController.isIncrementClicked.value = true;
  ...
  void _decrementCount() {
    setState(() {
      cartController.removeFromCart(cartController.cartItems.firstWhere((item) => item.productId == widget.restaurant?.productId));

      if (widget.count > 0) widget.count--;

      if(widget.count == 0){
        homeController.isIncrementClicked.value = false;
      }
    });
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CommonText(
                        text:
                        '₹ ${(widget.isDishes ? widget.dish?.storeProducts
                        ...
                        label: Row(
                          ...
                          children: [
                            ...
                            CommonText(
                              text:
                              '${(widget.isDishes ? widget.dish?.storeProducts
                                  ?.rating : widget.restaurant
                                  ?.rating)}(${Utility.countConverter(
                                  widget.isDishes ? widget.dish?.storeProducts
                                      ?.productDetails?.countOfRating
                                      ?.toInt() ?? 0 : widget.restaurant
                                      ?.productDetails?.countOfRating
                                      ?.toInt() ?? 0)})',
                              fontWeight: FontWeight.w500,
                              fontSize: 12,
                        ...
                        children: [
                          ...
                          if (widget.isDishes)
                            Expanded(
                              child: CommonText(
                                  text:
                                  "${widget.dish?.restaurantDetails?.first
                                      .name}",
                                  textOverflow: TextOverflow.ellipsis,
                                  textColor: AppColors.textLightColor),
                            ),
                            ...
                            children: [
                              ...
                              Chip(
                                label: CommonText(
                                  text:
                                  "${controller.restaurantList[index]
                                      .distanceInKilometer?.toStringAsFixed(
                                      1)} km",
                                  fontWeight: FontWeight.w500,
                                  fontSize: 10,
                                ),
