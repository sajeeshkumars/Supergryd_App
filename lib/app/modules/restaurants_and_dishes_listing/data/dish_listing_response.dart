...
DishListingResponse dishListingResponseFromJson(String str) =>
    DishListingResponse.fromJson(json.decode(str));

String dishListingResponseToJson(DishListingResponse data) =>
...
class Dishes {
  ...
  Dishes.fromJson(dynamic json) {
    ...
    _storeProducts = json['storeProducts'] != null
        ? StoreProducts.fromJson(json['storeProducts'])
        : null;
...
StoreProducts storeProductsFromJson(String str) =>
    StoreProducts.fromJson(json.decode(str));
...
class StoreProducts {
  ...
  StoreProducts.fromJson(dynamic json) {
    ...
    _isVeg = json['is_veg'];
    _productCategories = json['productCategories'] != null
...
class ProductCategories {
  ...
  ProductCategories.fromJson(dynamic json) {
    ...
    _backgroundImage = json['background_image'].toString();
    _heroImage = json['hero_image'].toString();
    _icons = json['icons'].toString();
    _spLocationId = json['sp_location_id'].toString();
  }
