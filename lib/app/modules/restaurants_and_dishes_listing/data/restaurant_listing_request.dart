...
RestaurantListingRequest restaurantListingRequestFromJson(String str) => RestaurantListingRequest.fromJson(json.decode(str));
String restaurantListingRequestToJson(RestaurantListingRequest data) => json.encode(data.toJson());
...
RestaurantListingRequest copyWith({  Location? location,
  num? page,
  num? limit,
  String? userId,
  String? serviceCategoryId,
}) => RestaurantListingRequest(  location: location ?? _location,
  page: page ?? _page,
  limit: limit ?? _limit,
