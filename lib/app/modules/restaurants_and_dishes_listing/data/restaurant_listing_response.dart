...
RestaurantListingResponse restaurantListingResponseFromJson(String str) =>
    RestaurantListingResponse.fromJson(json.decode(str));

String restaurantListingResponseToJson(RestaurantListingResponse data) =>
...
class RestaurantListingResponse {
  ...
  RestaurantListingResponse.fromJson(dynamic json) {
    ...
    _data = json['data'] != null
        ? RestaurantListingResult.fromJson(json['data'])
        : null;
  }
  ...
  RestaurantListingResponse copyWith({
    num? status,
    String? message,
    RestaurantListingResult? data,
  }) =>
...
RestaurantListingResult dataFromJson(String str) =>
    RestaurantListingResult.fromJson(json.decode(str));
...
class RestaurantListingResult {
  ...
  RestaurantListingResult copyWith({
    num? totalCount,
    List<RestaurantData>? restaurantData,
  }) =>
      RestaurantListingResult(
...
class RestaurantData {
  ...
  RestaurantData.fromJson(dynamic json) {
    ...
    _storeId = int.parse(json['store_id'].toString());
    _branchName = json['branch_name'].toString();
    _created = json['created'].toString();
    _location =
    ...
    _updated = json['updated'].toString();
    if (json['offers'] != null) {
      _offers = [];
    ...
    _totalRating = int.parse(json['total_rating'].toString());
    _serviceProviderId = json['service_provider_id'].toString();
    _distanceInKilometer = double.parse(json['distanceInKilometer'].toString());
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_moreBranchDetails != null) {
      map['more_branch_details'] =
          _moreBranchDetails?.map((v) => v.toJson()).toList();
    }
    map['status'] = _status;
...
MoreBranchDetails moreBranchDetailsFromJson(String str) =>
    MoreBranchDetails.fromJson(json.decode(str));

String moreBranchDetailsToJson(MoreBranchDetails data) =>
    json.encode(data.toJson());
...
class MoreBranchDetails {
  ...
  MoreBranchDetails.fromJson(dynamic json) {
    _cityName = json['city_name'].toString();
    _landmark = json['landmark'].toString();
    _localityName = json['locality_name'].toString();
    _societyName = json['society_name'].toString();
    _parentStoreId = int.parse(json['parent_store_id'].toString());
    _onTime = json['onTime'].toString();
    _offTime = json['offTime'].toString();
    _storeCode = json['store_code'].toString();
  }
