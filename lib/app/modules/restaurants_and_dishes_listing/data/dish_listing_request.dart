...
DishListingRequest dishListingRequestFromJson(String str) =>
    DishListingRequest.fromJson(json.decode(str));

String dishListingRequestToJson(DishListingRequest data) =>
