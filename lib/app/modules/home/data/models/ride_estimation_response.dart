...
RideEstimationResponse rideEstimationResponseFromJson(String str) => RideEstimationResponse.fromJson(json.decode(str));
String rideEstimationResponseToJson(RideEstimationResponse data) => json.encode(data.toJson());
...
RideEstimationResponse copyWith({  num? status,
  String? message,
  List<RideEstimationList>? data,
}) => RideEstimationResponse(  status: status ?? _status,
...
RideEstimationList dataFromJson(String str) => RideEstimationList.fromJson(json.decode(str));
...
RideEstimationList copyWith({  String? id,
  String? name,
  num? capacity,
  String? displayName,
  String? shortDescription,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_mappingProducts != null) {
      map['mapping_products'] = _mappingProducts?.map((v) => v.toJson()).toList();
    }
    if (_estimation != null) {
...
Estimation estimationFromJson(String str) => Estimation.fromJson(json.decode(str));
...
Estimation copyWith({  String? localizedDisplayName,
  String? displayName,
  String? productId,
  num? distance,
  dynamic highEstimate,
  ...
  num? estimate,
  String? currencyCode,
}) => Estimation(  localizedDisplayName: localizedDisplayName ?? _localizedDisplayName,
  displayName: displayName ?? _displayName,
...
MappingProducts mappingProductsFromJson(String str) => MappingProducts.fromJson(json.decode(str));
String mappingProductsToJson(MappingProducts data) => json.encode(data.toJson());
class MappingProducts {
  ...
  String? _productId;
  String? _productName;
MappingProducts copyWith({  String? serviceProvider,
  String? productId,
  String? productName,
}) => MappingProducts(  serviceProvider: serviceProvider ?? _serviceProvider,
  productId: productId ?? _productId,
